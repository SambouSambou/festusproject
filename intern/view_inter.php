    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="view_report">
        ...
        <div class="content-wrapper">
          ...
          <div class="clearfix mb-20">
            ...
            <table class="data-table stripe hover nowrap">
              <thead>
                <tr>
                  <th class="table-plus datatable-nosort">Intern ID</th>
                  <th class="table-plus datatable-nosort">Full Name</th>
                  <th class="table-plus datatable-nosort">Department</th>
                  <th class="table-plus datatable-nosort">Speciality</th>
              ...
              <tbody>
              <?php
 $query = "select InternID, fullname,DepartName,Specialty,startDate,endDate from interns";
...
?>
      ...
      <a class="dropdown-item" class="btn-block"   href='appdet.php?id=<?php echo "{$row["id"]}"?>'><i class="mdi mdi-eye"></i> View Details</a>
